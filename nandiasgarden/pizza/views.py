...
def order(request):
    ...
    if request.method == "POST":
        ...
        if filled_form.is_valid():
            ...
            note = 'Thanks for ordering! Your %s pizza with %s and %s is on its way!' %(filled_form.cleaned_data['size'],
...
def pizzas(request):
    ...
    PizzaFormSet = formset_factory(
        PizzaForm, extra=number_of_pizzas
    )
